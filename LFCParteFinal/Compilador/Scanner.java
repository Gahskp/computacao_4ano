...
public class Scanner {
	...
	static {
		...
		literals.put("void", new Integer(9));
		literals.put("if", new Integer(19));
		literals.put("while", new Integer(20));
		literals.put("read", new Integer(21));
		literals.put("write", new Integer(22));
		literals.put("program", new Integer(23));
		literals.put("int", new Integer(24));
		literals.put("bool", new Integer(25));
