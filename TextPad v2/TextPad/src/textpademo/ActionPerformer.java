...
public class ActionPerformer {
    ...
    public void actionNew() {
        if (tpEditor.documentHasChanged() == true) {    //si el documento esta marcado como modificado
            ...
            int option = JOptionPane.showConfirmDialog(tpEditor.getJFrame(), "Salvar alterações?");
        ...
        tpEditor.getJFrame().setTitle("TextPad Demo - Sem nome");    //nuevo título de la ventana
  ...
  //          } catch (BadLocationException ex) {
   ...
   //         }
    ...
    public void actionSelectFont() {
        ...
        appendToPane(tpEditor.getJTextPane(), "My Name is Too Good.\n", Color.RED);
        appendToPane(tpEditor.getJTextPane(), "I wish I could be ONE of THE BEST on ", Color.BLUE);
        appendToPane(tpEditor.getJTextPane(), "Stack", Color.DARK_GRAY);
        appendToPane(tpEditor.getJTextPane(), "Over", Color.MAGENTA);
        appendToPane(tpEditor.getJTextPane(), "flow", Color.ORANGE);
    }
    ...
    private static JFileChooser getJFileChooser() {
        ...
        fc.setDialogTitle("TextPad Demo - Escolher um arquivo:");    //se le establece un título
