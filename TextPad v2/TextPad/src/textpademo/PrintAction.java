...
public class PrintAction implements Printable {
    ...
    private final JTextPane jTextPane;    //área de edición donde se encuentra el documento actual
    ...
    public PrintAction(JComponent jComponent) {
        this.jTextPane = (JTextPane) jComponent;    //guarda la instancia del área de edición
    }
    ...
    public int print(Graphics g, PageFormat pf, int pageIndex) {
        ...
        if (pageBreaks == null) {    //si los quiebres de página no fueron calculados
            ...
            textLines = jTextPane.getText().split("\n");
        ...
        if (pageIndex != currentPage) {
            ...
            javax.swing.SwingUtilities.invokeLater(new Runnable() {
                ...
                public void run() {
                    ...
                    ((PrintingMessageBox) dialog).setStatusMsg("Imprimindo página " + (currentPage + 1) + " ...");
                }
            });
        }
    }
