...
//        }
//
//        /* Controle de transição entre a fase 1 e fase 2*/
//        if(stats.getPieces() >= 2 && stats.getFase2() == false){
...
//                }
//            }
//            System.out.println("Escolhe: " + escolhe);
//            System.out.println("Move: " + move);
//            if(escolhe == false && move == false){
//                escolhe = true;
//            } else {
//                if(escolhe == true && move == false){
//                    escolhe = false;
//                    move = true;
//                } else {
//                    if (escolhe == false && move == true){
//                       escolhe = false;
//                       move = false;
//                    }
//                }
