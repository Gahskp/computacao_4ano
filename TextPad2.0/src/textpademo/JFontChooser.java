...
class FontChooserDialog extends JDialog {
    ...
    public FontChooserDialog(Frame owner, String title, final JFontChooser jFontChooser) {
        ...
        textExample.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Texto de exemplo"),
        ...
        JButton buttonCancel = new JButton("Cancelar");    //construye el botón de cancelar
